export const dailyUpdateCategories = [
  { id: 'university', name: '大学百科', icon: '🎓', color: '#667eea' },
  { id: 'education', name: '升学规划', icon: '📚', color: '#4caf50' },
  { id: 'parenting', name: '孩子培养', icon: '👨‍👩‍👧', color: '#ff9800' },
  { id: 'travel', name: '生活旅游', icon: '✈️', color: '#e91e63' },
  { id: 'attraction', name: '景点推荐', icon: '🏞️', color: '#00bcd4' },
  { id: 'learning', name: '每日所学', icon: '💡', color: '#9c27b0' },
];
...
const generateUniversityContent = (day) => {
  const universities = [
    { name: '西安交通大学', fact: '中国最早的高等学府之一，前身是1896年创办的南洋公学', highlight: '双一流A类' },
    { name: '清华大学', fact: '中国顶尖学府，拥有22个A+学科，QS排名亚洲第一', highlight: 'C9联盟' },
    { name: '北京大学', fact: '中国近代第一所国立综合性大学，拥有18个A+学科', highlight: 'C9联盟' },
    { name: '复旦大学', fact: '位于上海，综合实力强劲，在人文社科领域尤为突出', highlight: 'C9联盟' },
    { name: '上海交通大学', fact: '工科实力全国领先，船舶海洋工程专业世界一流', highlight: 'C9联盟' },
    { name: '浙江大学', fact: '学科门类最齐全的大学之一，拥有11个A+学科', highlight: 'C9联盟' },
    { name: '南京大学', fact: '百年名校，在物理学、天文学领域处于顶尖水平', highlight: 'C9联盟' },
    { name: '中国科学技术大学', fact: '以理工科见长，科研实力雄厚，出国深造率高', highlight: 'C9联盟' },
    { name: '哈尔滨工业大学', fact: '工科强校，航天领域实力突出，被誉为"工程师摇篮"', highlight: 'C9联盟' },
    { name: '武汉大学', fact: '最美大学之一，法学、测绘等学科全国领先', highlight: '985工程' },
    { name: '华中科技大学', fact: '工科与医学并重，机械工程全国顶尖', highlight: '985工程' },
    { name: '中山大学', fact: '华南地区最高学府，医学和经管学科实力强劲', highlight: '985工程' },
  ];
...
export const addUpdateRecord = (category, content) => {
  const record = {
    id: Date.now(),
